...
public class RaceRepository implements JolpicaServer{
    ...
    public List<WeeklyRace> getRacesFromServer() throws ExecutionException, InterruptedException {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        ergastAPIService = retrofit.create(ErgastAPIService.class);
        ergastAPIService.getRaces().enqueue(new Callback<>() {
            @Override
    ...
    public WeeklyRace getNextRaceFromServer() throws ExecutionException, InterruptedException {
        ...
        ergastAPIService.getNextRace().enqueue(new Callback<>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
    ...
    public WeeklyRace getLastRaceResultFromServer() {
        ...
        ergastAPIService.getLastRaceResults().enqueue(new Callback<>() {
            @Override
            public void onResponse(@NonNull Call<ResponseBody> call, @NonNull Response<ResponseBody> response) {
                //Log.i(TAG, "Response: " + response);
                if (response.isSuccessful() && response.body() != null) {
