...
public class Constants {
    ...
    public static final Map<String, Integer> EVENT_COUNTRY_FLAG = new HashMap<>() {{
        ...
        put("albert_park", R.drawable.australia_flag);
        put("suzuka", R.drawable.japan_flag);
        put("shanghai", R.drawable.china_flag);
        put("miami", R.drawable.united_states_flag);
        put("imola", R.drawable.italy_flag);
        put("monaco", R.drawable.monaco_flag);
        put("villeneuve", R.drawable.canada_flag);
        put("catalunya", R.drawable.spain_flag);
        put("red_bull_ring", R.drawable.austria_flag);
        put("silverstone", R.drawable.united_kingdom_flag);
        put("hungaroring", R.drawable.hungary_flag);
        put("spa", R.drawable.belgium_flag);
        put("zandvoort", R.drawable.netherlands_flag);
        put("monza", R.drawable.italy_flag);
        put("baku", R.drawable.azerbaijan_flag);
        put("marina_bay", R.drawable.singapore_flag);
        put("americas", R.drawable.united_states_flag);
        put("rodriguez", R.drawable.mexico_flag);
        put("interlagos", R.drawable.brazil_flag);
        put("vegas", R.drawable.united_states_flag);
